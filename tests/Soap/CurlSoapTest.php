...
class CurlSoapTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $priKey = $this->pathCerts.'x99999090910270_priKEY.pem';
        $pubKey = $this->pathCerts.'x99999090910270_pubKEY.pem';
        $certKey = $this->pathCerts.'x99999090910270_certKEY.pem';
        $timeout = '10';
    ...
    {
        $priKey = $this->pathCerts.'x99999090910270_priKEY.pem';
        $pubKey = $this->pathCerts.'0000_pubKEY.pem';
        $certKey = $this->pathCerts.'x99999090910270_certKEY.pem';
        $timeout = '10';
        $soap = new CurlSoap($priKey, $pubKey, $certKey, $timeout);
    }
    ...
    public function testGetWsdl()
    {
        ...
        $fileretornosefaz = dirname(dirname(__FILE__)) .
        ...
        //resultado padrão
        $wsdlfile = dirname(dirname(__FILE__)) .
