...
class StringsTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $xmlSujo = file_get_contents(dirname(dirname(__FILE__)) . '/fixtures/xml/NFe/xml-sujo.xml');
        $xmlLimpo1 = file_get_contents(dirname(dirname(__FILE__)) . '/fixtures/xml/NFe/xml-limpo1.xml');
        $xmlLimpo2 = file_get_contents(dirname(dirname(__FILE__)) . '/fixtures/xml/NFe/xml-limpo2.xml');
