...
class DomTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $filePath = TEST_ROOT . '/fixtures/certs/99999090910270_certKEY.pem';
        $this->dom->loadXMLFile($filePath);
    }
    
    public function testLoadXMLFile()
    {
        $filePath = TEST_ROOT . '/fixtures/xml/NFe/35101158716523000119550010000000011003000000-nfeSigned.xml';
