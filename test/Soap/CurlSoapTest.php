...
class CurlSoapTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $priKey = TEST_ROOT . '/fixtures/certs/99999090910270_priKEY.pem';
        $pubKey = TEST_ROOT . '/fixtures/certs/99999090910270_pubKEY.pem';
        $certKey = TEST_ROOT . '/fixtures/certs/99999090910270_certKEY.pem';
        $timeout = 10;
    ...
    {
        $priKey = TEST_ROOT . '/fixtures/certs/99999090910270_priKEY.pem';
        $pubKey = TEST_ROOT . '/fixtures/certs/0000_pubKEY.pem';
        $certKey = TEST_ROOT . '/fixtures/certs/99999090910270_certKEY.pem';
        $timeout = '10';
        $soap = new CurlSoap($priKey, $pubKey, $certKey, $timeout);
    }
