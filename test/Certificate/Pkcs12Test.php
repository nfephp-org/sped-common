...
';
    ...
    {
        $pathCerts = TEST_ROOT . '/fixtures/fake';
        $cnpj = '99999090910270';
        $pubKey = '';
        $priKey = '';
        $certKey = '';
        $pkcs = new Pkcs12($pathCerts, $cnpj, $pubKey, $priKey, $certKey);
        $arquivopfx = TEST_ROOT . '/fixtures/certs/certificado_teste.pfx';
    ...
    /**
     * @expectedException Sped\Common\Exception\RuntimeException
    ...
    public function testAssinarXml()
    {
        ...
        $xmlpath = TEST_ROOT . '/fixtures/xml/NFe/35101158716523000119550010000000011003000000-nfe.xml';
        $docxml = file_get_contents($xmlpath);
        $signedxmlpath = TEST_ROOT . '/fixtures/xml/NFe/signed-nfe.xml';
    ...
    {
        $aCerts[] = TEST_ROOT . '/fixtures/certs/ACCertisignG6_v2.cer';
        $aCerts[] = TEST_ROOT . '/fixtures/certs/ACCertisignMultiplaG5.cer';
        $aCerts[] = TEST_ROOT . '/fixtures/certs/ACRaizBrasileira_v2.cer';
        $cert = $this->priPem . "\r\n" .
            $this->pubPem . "\r\n" .
            $this->accg6 . "\r\n" .
            $this->accmg5 . "\r\n" .
        ...
        $cnpj = '99999090910270';
        $pathCerts = TEST_ROOT . '/fixtures/certs';
        $ignoreValidCert = true;
        $pkcs = new Pkcs12($pathCerts, $cnpj, $this->pubPem, $this->priPem, '', $ignoreValidCert);
